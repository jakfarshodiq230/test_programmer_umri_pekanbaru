...
class CustomPdf extends TCPDF
{
    ...
    public function Footer()
    {
        ...
        $this->Line(18, $this->GetY(), 195, $this->GetY());

        $this->SetY(-36);
        // Set font
        $this->SetFont('helvetica','', 10);
        // Draw the first cell (left-aligned)
        $this->Cell(0, 2,date('d F Y'), 0, 0, 'R', 0);
        ...
        $this->SetFont('helvetica','', 10);
        // Draw the first cell (left-aligned)
        $this->Cell(0, 2,strtoupper($pelanggan->nama_pelanggan), 0, 0, 'R', 0);
        ...
        $this->Cell(0, 2,'Kuitansi ini merupakan bukti tanda sah atas transaksi', 0, 0, 'L', 0);
        $this->SetY(-20);
        $this->SetX(18);
        $this->SetFont('helvetica','i', 10);
        $this->Cell(0, 2,'pembelian barang yang telah dilakukan. Terima kasih atas kepercayaan Anda.', 0, 0, 'L', 0);
