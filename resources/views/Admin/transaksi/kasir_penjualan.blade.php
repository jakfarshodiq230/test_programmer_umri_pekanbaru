                                ...
                                <form id="dataForm" action="">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div style="text-align: right;" class="mb-0">
                            ...
                            <table id="dataTabel-ajax" class="table table-striped" style="width:100%">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th colspan="3" id="totalPayment">0</th>
                                    </tr>
                                </tfoot>
                            </table>
...
@section('scripts')
    <script>
        ...
        function saveDataToDatabase() {
            ...
            const url = '{{ url('kasir/proses_penjualan') }}';
                ...
                if (xhr.readyState === 4 && xhr.status === 200) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Swal.fire({
                                title: 'Lanjutkan?',
                                text: 'Apakah Anda ingin cetak bukti penjualan?',
                                icon: 'question',
                                ...
                                if (result.isConfirmed) {
                                    var lin_cetak = '{{ url('transaksi/cetak_rincian_penjualan') }}/' +
