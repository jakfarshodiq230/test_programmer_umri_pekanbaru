...
<script>
        ...
        function loadPeserta() {
            $.ajax({
                url: '{{ url('admin/peserta_sertifikasi/ajax_detail_peserta') }}/' + peserta,
                method: 'GET',
        ...
        $(document).on('click', '.downloadBtn', function() {
            var id = $(this).data('id');
            var url= '{{ url('admin/peserta_sertifikasi/cetak_sertifikat') }}/'+ id;
            window.location.href = url;
        });

        $(document).on('click', '.downloadSertifBtn', function() {
            var id = $(this).data('id');
            var url= '{{ url('admin/peserta_sertifikasi/download_sertifikat') }}/'+ id;
            window.location.href = url;
        });
