                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    ...
                                    <form action="{{ url('daftar_pelanggan/store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="mb-3">
                                                    <label>No. HP</label>
                                                    <input class="form-control form-control-lg" type="text"
                                                        name="no_hp" onkeypress="return hanyaAngka(event)" placeholder="No. HP" required />
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label>Alamat</label>
                                                <textarea class="form-control form-control-lg" name="alamat" placeholder="Jl. Utama" required></textarea>
                                            </div>
                                        </div>
