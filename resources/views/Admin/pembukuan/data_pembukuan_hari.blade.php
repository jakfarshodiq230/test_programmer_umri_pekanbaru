...
@section('scripts')
    <script>
        ...
        $('#datatables-ajax-periode').DataTable({
            ...
            destroy: true,
            responsive: true,
            ajax: '{{ url('pembukuan/data_pembukuan_hari_periode') }}',
            columns: [{
                    data: null,
                    name: 'nomor',
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        return row.judul_periode + '<br>[' + row.id_periode + ']';
                    }
                },
                {
        ...
        $('#saveBtn').on('click', function() {
            var url = '{{ url('pembukuan/store_pembukuan_hari') }}';
            $.ajax({
                url: url,
                method: 'POST',
        ...
        $(document).on('click', '.lihatBtn', function() {
            ...
            var url = '{{ url('pembukuan/data_pembukuan_hari_periode_rincian') }}/' + id + '/' + idPeriode;
