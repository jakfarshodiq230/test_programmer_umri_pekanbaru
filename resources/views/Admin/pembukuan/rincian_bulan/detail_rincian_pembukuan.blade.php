    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var pembelianTable = initDataTable('#datatables-ajax-pembelian',
                '{{ url('pembukuan/bulan/penjualan/list_data_detail_pembukuan_bulan_periode_rincian') }}/' +
                id_pembukuan + '/' +
                id_periode + '/' + tanggal, pembelianColumns);
            var penjualanTable = initDataTable('#datatables-ajax-penjualan',
                '{{ url('pembukuan/bulan/pembelian/list_data_detail_pembukuan_bulan_periode_rincian') }}/' +
                id_pembukuan + '/' +
                id_periode + '/' + tanggal, penjualanColumns);
            var pengeluaranTable = initDataTable('#datatables-ajax-pengeluaran',
                '{{ url('pembukuan/bulan/pengeluaran/list_data_detail_pembukuan_bulan_periode_rincian') }}/' +
                id_pembukuan +
        ...
        $(document).on('click', '.cetakBtn', function() {
            ...
            var url = '{{ url('pembukuan/bulan/cetak_detail_rincian_pdf') }}/' + pembukuan + '/' +
                periode + '/' + tanggal;
            iframe.src = url;
