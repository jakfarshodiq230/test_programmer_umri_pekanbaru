        ...
        <div class="container-fluid">
            ...
            <div class="header">
                <h1 class="header-title">
                    Detail Rincian Pembukuan Perbulan
                </h1>
            </div>
            <div class="row">
                <div class="col-12">
...
@section('scripts')
    <script>
        ...
        $('#datatables-ajax-periode').DataTable({
            ...
            destroy: true,
            responsive: true,
            ajax: '{{ url('pembukuan/list_data_pembukuan_bulan_periode_rincian') }}/' + id_pembukuan + '/' +
                id_periode,
            columns: [{
                    data: null,
                    name: 'nomor',
                ...
                {
                    data: 'bulan_pembukuan',
                    name: 'bulan_pembukuan',
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                                <button class="btn btn-sm btn-primary lihatBtn" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat Data" data-pembukuan="${row.id_pembukuan}" data-periode="${row.id_periode}" data-tggl ="${row.bulan_pembukuan}"><i class="fas fa-eye"></i></button>
                            `;
                    }
                }
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    ...
                    $.ajax({
                        url: '{{ url('pembukuan/list_data_pembukuan_bulan_periode_rincian') }}/' +
                            id_pembukuan + '/' + id_periode,
                        type: 'GET',
                        xhr: function() {
        ...
        $(document).on('click', '.lihatBtn', function() {
            ...
            var url = '{{ url('pembukuan/data_detail_pembukuan_bulan_periode_rincian') }}/' + pembukuan + '/' +
                periode + '/' + tanggal;
        ...
        $(document).on('click', '.cetakBtn', function() {
            var pembukuan = $(this).data('pembukuan');
            var periode = $(this).data('periode');
            var url = '{{ url('pembukuan/bulan/cetak_rincian_pdf') }}/' + pembukuan + '/' + periode + '/' + bulan;
