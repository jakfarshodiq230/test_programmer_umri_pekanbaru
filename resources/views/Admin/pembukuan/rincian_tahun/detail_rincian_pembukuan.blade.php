    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var pembelianTable = initDataTable('#datatables-ajax-pembelian',
                '{{ url('pembukuan/tahun/penjualan/list_data_detail_pembukuan_tahun_periode_rincian') }}/' +
                id_pembukuan + '/' +
                id_periode + '/' + tahun, pembelianColumns);
            var penjualanTable = initDataTable('#datatables-ajax-penjualan',
                '{{ url('pembukuan/tahun/pembelian/list_data_detail_pembukuan_tahun_periode_rincian') }}/' +
                id_pembukuan + '/' +
                id_periode + '/' + tahun, penjualanColumns);
            var pengeluaranTable = initDataTable('#datatables-ajax-pengeluaran',
                '{{ url('pembukuan/tahun/pengeluaran/list_data_detail_pembukuan_tahun_periode_rincian') }}/' +
                id_pembukuan +
                '/' + id_periode + '/' + tahun, pengeluaranColumns);
        });
        // cetak
        $(document).on('click', '.cetakBtn', function() {
            var pembukuan = $(this).data('pembukuan');
            var periode = $(this).data('periode');
            var tahun = $(this).data('tggl');
            let iframe = document.getElementById('printIframe');
            var url = '{{ url('pembukuan/tahun/cetak_detail_rincian_pdf') }}/' + pembukuan + '/' +
                periode + '/' + tahun;
            iframe.src = url;
