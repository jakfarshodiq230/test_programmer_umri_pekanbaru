...
<body>
    <span class="kalimat_pembuka">Identitas Akun Anda pada APKIS</span>
    <br><br>
    {{-- isi --}}
    <table>
        <tr>
    ...
    {{-- end isi --}}
    <br><br>
    <span class="kalimat_isi">Silahkan lanjutkan dengan<span> <a href="{{$data['link']}}"> klink</a> untuk merubah password anda
