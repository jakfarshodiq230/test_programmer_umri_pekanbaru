...
<div style="text-align: center; margin-top:0px;">
    <table id="tb-item" cellpadding="2" style="border-collapse: collapse; width: 100%;">
        <tr style="background-color:#a9a9a9">
            ...
            <th width="13%" style="height: 40px;text-align:center; vertical-align: middle;" rowspan="2"><strong>Penilaian</strong></th>
            <th width="15%" style="height: 40px;text-align:center; vertical-align: middle;" rowspan="2"><strong>Surah</strong></th>
            <th colspan="4" width="47%" style="height: 20px; text-align:center"><strong>Nilai</strong></th>
        ...
        <tr>
            ...
            <td style="height: 20px;text-align:center; padding-top: 10px; padding-bottom: 10px;">{{ ucwords($value->nilai_ghunnah_penilaian_kegiatan) }}</td>
            <td style="height: 20px;text-align:center; padding-top: 10px; padding-bottom: 10px;">{{ ucwords($value->nilai_mad_penilaian_tahsin) }}</td>
            <td style="height: 20px;text-align:center; padding-top: 10px; padding-bottom: 10px;">{{ ucwords($value->nilai_waqof_penilaian_tahsin) }}</td>
