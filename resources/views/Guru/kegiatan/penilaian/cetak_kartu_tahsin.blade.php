...
<table cellpadding="2" >
    <tr>
        <th width="15%">Nama</th>
        <th width="50%">: <b> {{ ucwords($identitas->nama_siswa) }}</b></th>
        <th width="10%">Semester</th>
        <th width="40%">: <b> {{ ucwords($identitas->jenis_kegiatan) }}</b></th>
    </tr>
    <tr>
        <th width="15%">Kelas/Program</th>
        <th width="50%">: <b> {{ $identitas->nama_kelas.' / '.ucwords($identitas->jenis_periode) }}</b></th>
        <th width="10%">Periode</th>
        <th width="40%">: <b> {{ $identitas->nama_tahun_ajaran}}</b></th>
    </tr>
</table>
<br>
